...
- The 4-row visible result was still incomplete. The latest completed daily run must contain the current full paper-tracking set, including the three P3 true-forward controls.
