...
| Runtime confirmed top5 optimization | research_candidate_found_blocked | 2026-07-04 registered `confirmed_concentrated_liquidity_momentum_20d_v1`, adding PIT `return_20d_percentile` and `industry_return_20d_excess` confirmation to the concentrated liquidity/momentum seed. Real 160-date report `model-comparison-report-af5214debc6b5fea` improves top5 net excess to `0.0982`, positive top5 rate to `0.6750`, Rank IC to `-0.0042`, DSR to `0.999996`, PBO `0.0`, and winner dependency ready. This is the current收益最优 research candidate, still blocked from production by governance/execution gates. |
| Runtime balanced top5 risk-control candidate | research_candidate_found_blocked | 2026-07-04 registered `balanced_confirmed_concentrated_liquidity_momentum_20d_v1`, adding turnover and volatility caps on top of the confirmed candidate. Real 160-date report `model-comparison-report-b7852b296bb2bca8` lowers top5 net excess to `0.0784` but raises positive top5 rate to `0.7625`. Monthly diagnostics show Jan/Feb means improve from negative to positive versus confirmed, while Apr/May strong-trend收益 is sacrificed. Treat this as a弱市/胜率 control candidate, not the收益最优 candidate. |
