...
| Runtime light risk-scaled top5 candidate | research_comparison_ready_governance_blocked | 2026-07-04 added PIT volatility/turnover position scaling: top5 picks remain the same selection family, but high-risk picks receive reduced portfolio weight and unused exposure is cash. Light scaling report `model-comparison-report-863ce9de9ed3a4fb` is the first current candidate whose model comparison report clears overfit, winner-dependency and execution-stress diagnostics: top5 net excess `0.0722`, positive top5 rate `0.7750`, DSR `0.999998`, PBO `0.0`, all monthly means positive, path drawdown proxy `-0.9362`, and winner dependency remains positive after removing top symbol/date/month. It is still blocked from production/dashboard exposure by governance and real execution gates: T+1, suspension/limit buy/sellability, fees/slippage/stamp tax, and ADV capacity/fill. |
