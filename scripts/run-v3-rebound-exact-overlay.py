...
from ashare_evidence.v3_rebound_exact_overlay import (
    run_v3_rebound_exact_overlay,
    write_v3_rebound_exact_overlay_result,
)


def main() -> int:
    parser = argparse.ArgumentParser(description="Run the preregistered exact V3 rebound-date subset overlay.")
    ...
    payload = run_v3_rebound_exact_overlay(
    ...
    write_v3_rebound_exact_overlay_result(args.output, payload)
    print(
        json.dumps(
            {
                ...
                "selection_audit": payload["overlay_selection_audit"],
