...
from ashare_evidence.external_sector_momentum_rerank import (
    run_external_sector_momentum_rerank_ablation,
    write_external_sector_momentum_rerank_result,
)


def main() -> int:
    parser = argparse.ArgumentParser(description="Run the preregistered near-tie SW sector momentum rerank.")
    ...
    payload = run_external_sector_momentum_rerank_ablation(
    ...
    write_external_sector_momentum_rerank_result(args.output, payload)
    print(
        json.dumps(
            {
