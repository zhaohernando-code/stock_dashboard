...
from ashare_evidence.v3_rebound_timing_overlay import (
    run_v3_rebound_timing_overlay,
    write_v3_rebound_timing_overlay_result,
)


def main() -> int:
    parser = argparse.ArgumentParser(description="Run the preregistered cash-isolated V3 rebound timing overlay.")
    ...
    payload = run_v3_rebound_timing_overlay(
    ...
    write_v3_rebound_timing_overlay_result(args.output, payload)
    print(
        json.dumps(
            {
