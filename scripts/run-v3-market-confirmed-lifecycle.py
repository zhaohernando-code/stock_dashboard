...
from ashare_evidence.v3_market_confirmed_lifecycle import (
    run_v3_market_confirmed_lifecycle_challenger,
    write_v3_market_confirmed_lifecycle_result,
)


def main() -> int:
    parser = argparse.ArgumentParser(description="Run the preregistered market-confirmed lifecycle challenger.")
    ...
    payload = run_v3_market_confirmed_lifecycle_challenger(
    ...
    write_v3_market_confirmed_lifecycle_result(args.output, payload)
    print(
        json.dumps(
            {
