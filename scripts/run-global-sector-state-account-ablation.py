...
from ashare_evidence.global_sector_state_account_ablation import (
    run_global_sector_state_account_ablation,
    write_ablation_result,
)


def main() -> int:
    parser = argparse.ArgumentParser(description="Run the preregistered global/sector state account ablation.")
    ...
    payload = run_global_sector_state_account_ablation(
