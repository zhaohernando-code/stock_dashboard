...
- Global hook or workspace-governance requests must not route here merely because they contain broad terms such as “评估”, “推荐”, or “专业性”. Only stock-specific phrases such as “股票专业性评估”, “A股推荐”, “短线关注池”, explicit project paths, or stock-dashboard aliases should select this repo.
...
- Project documentation-only changes do not require runtime publish, but any code/config/schema/script change that can affect `https://hernando-zhao.cn/stocks` or `/projects/ashare-dashboard/` remains live-facing and must follow the publish and browser acceptance flow.
