...
def build_latest_v3_candidate_run_source(
    ...
    *,
    ...
    spec = _model_spec_by_id(registry, model_spec_id)
    ...
    predictions = [
        _projection_prediction(
            ...
            trial_id=f"{model_spec_id}:trial-000",
            fitted_model=fitted_model,
    ...
    return {
        ...
        "selection_allowed_row_count": sum(1 for row in predictions if row.get("selection_allowed", True)),
