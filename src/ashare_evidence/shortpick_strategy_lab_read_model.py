    ...
    return {
        ...
        "source_artifacts": {
            "full_history_account_replay": {
                ...
                "path": "/private/tmp/stock_dashboard_v3_rolling_account_replay_20w_full713_layered_exit_rank3_gate_20260708.json",
        ...
        "data_scope": {
            ...
            "signal_day_count": 491,
            "selected_pick_count": 1473,
            "market_symbol_count": 575,
        ...
        "summary": {
            ...
            "main_total_return": 2.9891730075000016,
            "main_annualized_return": 0.6396381424285358,
            "main_max_drawdown": -0.07807961981120703,
            "main_negative_month_count": 4,
            "main_skipped_order_rate": 0.36123853211009177,
            "main_skipped_signal_rate": 0.2505091649694501,
            "main_final_nav_cny": 797834.6015000003,
        },
...
def _main_config_readout() -> dict[str, Any]:
    return {
        ...
        "summary": {
            "total_return": 2.9891730075000016,
            "annualized_return": 0.6396381424285358,
            "max_drawdown": -0.07807961981120703,
            "negative_month_count": 4,
            "worst_monthly_return": -0.017802132479532773,
            "skipped_order_rate": 0.36123853211009177,
            "skipped_signal_rate": 0.2505091649694501,
            "buy_order_count": 557,
            "sell_order_count": 557,
            "final_nav_cny": 797834.6015000003,
            "mean_invested_ratio": 0.6393399042767908,
            "p95_invested_ratio": 0.9600740291640368,
            "max_single_symbol_exposure_pct": 0.26759840945531743,
            "max_position_count": 36,
            "turnover": 82.0205001675,
        },
        "selection_summary": {
            "tranche_count": 14,
        ...
        "reason_counts": {
            "below_min_order_notional": 251,
            "insufficient_cash": 15,
            "missing_entry_bar_near_signal": 18,
            "price_too_high_for_slot": 27,
            "single_symbol_concentration_cap": 4,
        },
        "decision_samples": [],
    }
...
def _control_config_readout() -> dict[str, Any]:
    return {
        ...
        "summary": {
            "total_return": 2.7541370175000006,
            "annualized_return": 0.6044371939927242,
            "max_drawdown": -0.07906642326361568,
            "negative_month_count": 5,
            "worst_monthly_return": -0.01726134810266111,
            "skipped_order_rate": 0.21788990825688073,
            "skipped_signal_rate": 0.219959266802444,
            "buy_order_count": 682,
            "sell_order_count": 682,
            "final_nav_cny": 750827.4035000001,
            "mean_invested_ratio": 0.6220963232048106,
            "p95_invested_ratio": 0.9405897428094818,
            "max_single_symbol_exposure_pct": 0.2531276230484541,
            "max_position_count": 37,
            "turnover": 76.7635804575,
        },
        "selection_summary": {
            "tranche_count": 15,
            "budget_mode": "current_nav_fraction",
        ...
        "reason_counts": {
            "below_min_order_notional": 75,
            "insufficient_cash": 9,
            "missing_entry_bar_near_signal": 18,
            "price_too_high_for_slot": 86,
            "single_symbol_concentration_cap": 2,
        },
        "decision_samples": [],
    }
    ...
    return [
        {
            ...
            "items": [
                ...
                {"label": "最终净值", "value": 797834.6015000003, "format": "currency"},
                {"label": "总收益", "value": 2.9891730075000016, "format": "percent"},
                {"label": "年化收益", "value": 0.6396381424285358, "format": "percent"},
            ],
        },
        {
            "title": "稳定性与回撤",
            "items": [
                {"label": "最大回撤", "value": -0.07807961981120703, "format": "percent"},
                {"label": "负收益月份", "value": 4, "format": "number"},
                {"label": "最差月收益", "value": -0.017802132479532773, "format": "percent"},
                {"label": "平均投入比例", "value": 0.6393399042767908, "format": "percent"},
            ],
        },
        {
            "title": "执行约束",
            "items": [
                {"label": "买入订单", "value": 557, "format": "number"},
                {"label": "订单跳过率", "value": 0.36123853211009177, "format": "percent"},
                {"label": "信号跳过率", "value": 0.2505091649694501, "format": "percent"},
                {"label": "最大单票暴露", "value": 0.26759840945531743, "format": "percent"},
            ],
        },
    ]
