...
from ashare_evidence.shortpick_replay_feedback_stats import (
    _baseline_label,
    _best_group,  # noqa: F401 - re-exported for legacy private-helper tests.
    _candidate_industry,
    _clustered_bootstrap_interval,  # noqa: F401 - re-exported for legacy private-helper tests.
    _count_by,
    _group_excess,  # noqa: F401 - re-exported for legacy private-helper tests.
    _mean,  # noqa: F401 - re-exported for legacy private-helper tests.
    _mean_or_none,  # noqa: F401 - re-exported for legacy private-helper tests.
    _percentile,  # noqa: F401 - re-exported for legacy private-helper tests.
    _positive_rate,  # noqa: F401 - re-exported for legacy private-helper tests.
    _replay_confidence_intervals,
    _replay_feedback_groups,
    _replay_feedback_scope,
    _replay_group_sort_key,  # noqa: F401 - re-exported for legacy private-helper tests.
    _replay_statistical_gate,
    _robustness_metrics,
    _round_or_none,  # noqa: F401 - re-exported for legacy private-helper tests.
    _trimmed_mean_or_none,  # noqa: F401 - re-exported for legacy private-helper tests.
    _worst_group,  # noqa: F401 - re-exported for legacy private-helper tests.
)
from ashare_evidence.shortpick_replay_projection import (
    _industry_theme_return_attribution,  # noqa: F401 - re-exported for legacy private-helper tests.
    _industry_theme_stability_rows,  # noqa: F401 - re-exported for legacy private-helper tests.
    _market_regime_stability_rows,  # noqa: F401 - re-exported for legacy private-helper tests.
    _market_regime_tags_by_date,  # noqa: F401 - re-exported for legacy private-helper tests.
    _replay_regime_stability_projection,
    _replay_return_attribution,
    _return_attribution_row,  # noqa: F401 - re-exported for legacy private-helper tests.
    _sample_std,  # noqa: F401 - re-exported for legacy private-helper tests.
    _time_slice_rows,  # noqa: F401 - re-exported for legacy private-helper tests.
)
...
def build_shortpick_replay_feedback(session: Session, *, run_id: int | None = None) -> dict[str, Any]:
    ...
    aggregate_projection = (
        {
            "regime_stability": _replay_regime_stability_projection(rows, session=session),
        ...
        rows.append(
            {
                ...
                "industry": _candidate_industry(candidate_payload),
