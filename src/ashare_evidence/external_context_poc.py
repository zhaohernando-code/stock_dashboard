...
def build_external_context_provider_audit(
    ...
    *,
    ...
    provider_rows = [
        _audit_provider(provider, hard_gate_ids=hard_gate_ids, sample=sample_by_provider.get(str(provider.get("provider_id"))))
        ...
        layer_rows.append(
            {
                ...
                "layer_status": "ready" if ready_primary and ready_fallback else "blocked",
                "blocking_reason": None if ready_primary and ready_fallback else "primary_and_independent_fallback_not_both_ready",
            }
        )
...
def _audit_provider(
    ...
    *,
    ...
    if documentation_failures or sample_failures:
        audit_status = "blocked"
    elif documentation_pending or sample_pending:
