...
from ashare_evidence import shortpick_source_audit as _source_audit
...
_source_credibility = _source_audit.source_credibility
_source_support_check = _source_audit.source_support_check
