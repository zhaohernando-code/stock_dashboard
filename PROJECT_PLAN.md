...
Current step: `Phase 5 - Real Validation Rebuild and Model Portfolio Policy Research` remains in progress; the missing-news producer hard block has now been narrowed, published, and browser-verified, while replay time-window accumulation plus broader holding-policy / horizon evidence hardening remain open
