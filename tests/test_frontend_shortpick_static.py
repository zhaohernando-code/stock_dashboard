...
class FrontendShortpickStaticTests(unittest.TestCase):
    def test_shortpick_strategy_lab_replaces_v2_surface(self) -> None:
        ...
        self.assertIn("4 个账户统一从 2026-07-08 起算", component_source)
        ...
        self.assertIn("3 个 V3 角色 + 1 个外部信息对照统一从 2026-07-08 起算", component_source)
        self.assertIn("外部信息对照直接进入下方同一策略表格、账户曲线和交易明细", component_source)
