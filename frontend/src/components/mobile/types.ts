...
export type MobileTabKey = "home" | "stock" | "operations" | "shortpick" | "shortpick-strategy-lab" | "settings";
export type MobileStockPanelKey = "advice" | "evidence" | "risk" | "question";
export type MobileViewMode = "candidates" | "stock" | "operations" | "shortpick" | "shortpick-strategy-lab" | "settings";
